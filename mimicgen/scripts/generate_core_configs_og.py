...
def make_generators(base_configs):
    ...
    all_settings = [
        ...
        dict(
            ...
            dataset_name="test_tiago_single_arm_cup",
            generation_path="{}/test_tiago_single_arm_cup".format(OUTPUT_FOLDER),
            tasks=["test_tiago_single_arm_cup_D0", "test_tiago_single_arm_cup_D1", "test_tiago_single_arm_cup_D2"],
            task_names=["D0", "D1", "D2"],
            select_src_per_subtask=False,
            selection_strategy="random",
            selection_strategy_kwargs=None,
